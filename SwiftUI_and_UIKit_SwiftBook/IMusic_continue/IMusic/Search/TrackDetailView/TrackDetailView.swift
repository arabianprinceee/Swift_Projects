...
class TrackDetailView: UIView {
    ...
    @IBAction func handleCurrentTimeSlider(_ sender: Any) {
        ...
        let seekTimeInSeconds = Float(percentage) * Float(durationInSeconds)
        let seekTime = CMTimeMakeWithSeconds(Float64(seekTimeInSeconds), preferredTimescale: 1)
    ...
    @IBAction func nextTrack(_ sender: Any) {
        ...
        guard let _cellViewModel = cellViewModel else { return }
        self.set(viewModel: _cellViewModel)
    }
